...
\begin{table}[h!]
	\begin{center}
		\scalebox{0.6}{
			\input{./Tables/Table_Regression_comparison.tex}}
		\caption{}
	\end{center}
\end{table}
\vspace{-3mm}
...
\begin{table}[h!]
	\begin{center}
		\scalebox{0.6}{
			\input{./Tables/Table_Regression_comparison_compact.tex}}
		\caption{}
	\end{center}
\end{table}
\vspace{-3mm}
...
\begin{table}[h!]
	\begin{center}
		\scalebox{0.6}{
			\input{./Tables/Table_Regression_comparison_full.tex}}
		\caption{}
	\end{center}
\end{table}
\vspace{-3mm}
...
\begin{table}[h!]
	\begin{center}
		\scalebox{0.6}{
			\input{./Tables/Table_Regression_comparison_full_compact.tex}}
		\caption{}
	\end{center}
\end{table}
\vspace{-3mm}
...
\begin{table}[h!]
	\begin{center}
		\scalebox{0.6}{
			\input{./Tables/Table_Regression_comparison_simple.tex}}
		\caption{}
	\end{center}
\end{table}
\vspace{-3mm}
...
\begin{table}[h!]
	\begin{center}
		\scalebox{0.4}{
			\input{./Tables/Table_Regression_comparison_full_long.tex}}
		\caption{}
	\end{center}
\end{table}
